...
class TestStoryDataModels:
    ...
    def test_model_validation(self):
        ...
        request = StoryGenerationRequest(narrative="Valid narrative")
        assert request.narrative == "Valid narrative"

        # Test that empty narrative in variants request also fails
        with pytest.raises(ValidationError) as exc_info:
            StoryVariantsRequest(narrative="", count=3)
        assert "Narrative cannot be empty" in str(exc_info.value)
